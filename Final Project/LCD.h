...
#define DDR_LCD					DDRD			//Set Data direction for LCD
#define LCD_PORT 				PORTD			//Set Port for Data Transfer in LCD
#define DDR_Control_PORT		DDRC			//Set Data direction for control of LCD
#define LCD_Control_PORT		PORTC			//Set Port for control of LCD
#define Enable 					6				//Set Pin for Enable Switch
